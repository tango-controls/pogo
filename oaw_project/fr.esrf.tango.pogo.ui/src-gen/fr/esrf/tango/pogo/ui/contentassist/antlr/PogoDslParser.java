		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPogoMultiClassesAccess().getClassesAssignment_8(), "rule__PogoMultiClasses__ClassesAssignment_8");
					put(grammarAccess.getPogoMultiClassesAccess().getFilestogenerateAssignment_9(), "rule__PogoMultiClasses__FilestogenerateAssignment_9");
					put(grammarAccess.getPogoMultiClassesAccess().getPreferencesAssignment_10(), "rule__PogoMultiClasses__PreferencesAssignment_10");
