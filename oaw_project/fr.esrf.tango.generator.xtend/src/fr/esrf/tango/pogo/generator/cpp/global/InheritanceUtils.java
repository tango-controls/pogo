...
public class InheritanceUtils {
	...
	public boolean isConcreteClass(PogoDeviceClass cls) {
		return StringUtils.isFalse(cls.getDescription().getHasAbstractAttribute()) &&
				StringUtils.isFalse(cls.getDescription().getHasAbstractCommand()) ;
	}
	...
	public boolean isAbstract(Attribute attribute) {
		return StringUtils.isTrue(attribute.getStatus().getAbstract()) &&
				StringUtils.isTrue(attribute.getStatus().getInherited())==false &&
				StringUtils.isTrue(attribute.getStatus().getConcreteHere())==false;
	}
	//===========================================================
	public boolean isAbstract(Command command) {
		return StringUtils.isTrue(command.getStatus().getAbstract()) &&
				StringUtils.isTrue(command.getStatus().getInherited())==false &&
				StringUtils.isTrue(command.getStatus().getConcreteHere())==false;
	}
	//===========================================================
