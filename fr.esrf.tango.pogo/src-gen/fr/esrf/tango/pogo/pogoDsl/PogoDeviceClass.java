 ...
 *   <li>{@link fr.esrf.tango.pogo.pogoDsl.PogoDeviceClass#getForwardedAttributes <em>Forwarded Attributes</em>}</li>
 *   <li>{@link fr.esrf.tango.pogo.pogoDsl.PogoDeviceClass#getPipes <em>Pipes</em>}</li>
...
public interface PogoDeviceClass extends EObject
{
   ...
   * The list contents are of type {@link fr.esrf.tango.pogo.pogoDsl.ForwardedAttribute}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see fr.esrf.tango.pogo.pogoDsl.PogoDslPackage#getPogoDeviceClass_ForwardedAttributes()
   * @model containment="true"
   * @generated
   */
   ...
   * The list contents are of type {@link fr.esrf.tango.pogo.pogoDsl.Pipe}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see fr.esrf.tango.pogo.pogoDsl.PogoDslPackage#getPogoDeviceClass_Pipes()
   * @model containment="true"
   * @generated
   */
  EList<Pipe> getPipes();
