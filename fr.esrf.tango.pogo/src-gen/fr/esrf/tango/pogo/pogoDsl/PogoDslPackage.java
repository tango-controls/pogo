...
public interface PogoDslPackage extends EPackage
{
   ...
   * @ordered
   */
  int POGO_MULTI_CLASSES__COPYRIGHT = 6;
   ...
   * @ordered
   */
  int POGO_MULTI_CLASSES__CLASSES = 7;
   ...
   * @ordered
   */
  int POGO_MULTI_CLASSES__FILESTOGENERATE = 8;
   ...
   * @ordered
   */
  int POGO_MULTI_CLASSES__PREFERENCES = 9;
   ...
   * @ordered
   */
  int POGO_MULTI_CLASSES_FEATURE_COUNT = 10;
   ...
   * @ordered
   */
  int POGO_DEVICE_CLASS__POGO_REVISION = 3;
   ...
   * @ordered
   */
  int POGO_DEVICE_CLASS__INSTITUTE = 4;
   ...
   * @ordered
   */
  int POGO_DEVICE_CLASS__DESCRIPTION = 5;
   ...
   * @ordered
   */
  int POGO_DEVICE_CLASS__CLASS_PROPERTIES = 6;
   ...
   * @ordered
   */
  int POGO_DEVICE_CLASS__DEVICE_PROPERTIES = 7;
  ...
  /**
   * The feature id for the '<em><b>Forwarded Attributes</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   ...
   * @ordered
   */
  int CLASS_DESCRIPTION__COPYRIGHT = 9;
   ...
   * @ordered
   */
  int CLASS_DESCRIPTION__HAS_MANDATORY_PROPERTY = 10;
   ...
   * @ordered
   */
  int CLASS_DESCRIPTION__HAS_CONCRETE_PROPERTY = 11;
   ...
   * @ordered
   */
  int CLASS_DESCRIPTION__HAS_ABSTRACT_COMMAND = 12;
   ...
   * @ordered
   */
  int CLASS_DESCRIPTION__HAS_ABSTRACT_ATTRIBUTE = 13;
   ...
   * @ordered
   */
  int CLASS_DESCRIPTION__DESCRIPTION_HTML_EXISTS = 14;
   ...
   * @ordered
   */
  int CLASS_DESCRIPTION_FEATURE_COUNT = 15;
  ...
  /**
   * The feature id for the '<em><b>Event Criteria</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ATTRIBUTE__EVENT_CRITERIA = 18;

  /**
   * The feature id for the '<em><b>Ev Archive Criteria</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '{@link fr.esrf.tango.pogo.pogoDsl.impl.ForwardedAttributeImpl <em>Forwarded Attribute</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.esrf.tango.pogo.pogoDsl.impl.ForwardedAttributeImpl
   * @see fr.esrf.tango.pogo.pogoDsl.impl.PogoDslPackageImpl#getForwardedAttribute()
   * @generated
   */
  int FORWARDED_ATTRIBUTE = 19;
   ...
   * @ordered
   */
  int FORWARDED_ATTRIBUTE__NAME = 0;
   ...
   * @ordered
   */
  int FORWARDED_ATTRIBUTE__LABEL = 1;
   ...
   * @ordered
   */
  int FORWARDED_ATTRIBUTE__STATUS = 2;

  /**
   * The number of structural features of the '<em>Forwarded Attribute</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int FORWARDED_ATTRIBUTE_FEATURE_COUNT = 3;
  ...
  /**
   * The meta object id for the '{@link fr.esrf.tango.pogo.pogoDsl.impl.EventCriteriaImpl <em>Event Criteria</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.esrf.tango.pogo.pogoDsl.impl.EventCriteriaImpl
   * @see fr.esrf.tango.pogo.pogoDsl.impl.PogoDslPackageImpl#getEventCriteria()
   * @generated
   */
  int EVENT_CRITERIA = 21;

  /**
   * The feature id for the '<em><b>Rel Change</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EVENT_CRITERIA__REL_CHANGE = 0;

  /**
   * The feature id for the '<em><b>Abs Change</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EVENT_CRITERIA__ABS_CHANGE = 1;
   ...
   * @ordered
   */
  int EVENT_CRITERIA__PERIOD = 2;

  /**
   * The number of structural features of the '<em>Event Criteria</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EVENT_CRITERIA_FEATURE_COUNT = 3;
   ...
   * @generated
   */
  int OVERLODED_POLL_PERIOD_OBJECT = 24;
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.esrf.tango.pogo.pogoDsl.PogoMultiClasses#getCopyright <em>Copyright</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Copyright</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.PogoMultiClasses#getCopyright()
   * @see #getPogoMultiClasses()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.esrf.tango.pogo.pogoDsl.OneClassSimpleDef#getHasDynamic <em>Has Dynamic</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Has Dynamic</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.OneClassSimpleDef#getHasDynamic()
   * @see #getOneClassSimpleDef()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.esrf.tango.pogo.pogoDsl.PogoDeviceClass#getPogoRevision <em>Pogo Revision</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Pogo Revision</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.PogoDeviceClass#getPogoRevision()
   * @see #getPogoDeviceClass()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.esrf.tango.pogo.pogoDsl.PogoDeviceClass#getForwardedAttributes <em>Forwarded Attributes</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Forwarded Attributes</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.PogoDeviceClass#getForwardedAttributes()
   * @see #getPogoDeviceClass()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.esrf.tango.pogo.pogoDsl.ClassDescription#getCopyright <em>Copyright</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Copyright</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.ClassDescription#getCopyright()
   * @see #getClassDescription()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link fr.esrf.tango.pogo.pogoDsl.Attribute#getEventCriteria <em>Event Criteria</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Event Criteria</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.Attribute#getEventCriteria()
   * @see #getAttribute()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link fr.esrf.tango.pogo.pogoDsl.Attribute#getEvArchiveCriteria <em>Ev Archive Criteria</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Ev Archive Criteria</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.Attribute#getEvArchiveCriteria()
   * @see #getAttribute()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link fr.esrf.tango.pogo.pogoDsl.ForwardedAttribute <em>Forwarded Attribute</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Forwarded Attribute</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.esrf.tango.pogo.pogoDsl.ForwardedAttribute#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.ForwardedAttribute#getName()
   * @see #getForwardedAttribute()
   * @generated
   */
  EAttribute getForwardedAttribute_Name();

  /**
   * Returns the meta object for the attribute '{@link fr.esrf.tango.pogo.pogoDsl.ForwardedAttribute#getLabel <em>Label</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Label</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.ForwardedAttribute#getLabel()
   * @see #getForwardedAttribute()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link fr.esrf.tango.pogo.pogoDsl.ForwardedAttribute#getStatus <em>Status</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Status</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.ForwardedAttribute#getStatus()
   * @see #getForwardedAttribute()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link fr.esrf.tango.pogo.pogoDsl.EventCriteria <em>Event Criteria</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Event Criteria</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.esrf.tango.pogo.pogoDsl.EventCriteria#getRelChange <em>Rel Change</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Rel Change</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.EventCriteria#getRelChange()
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.esrf.tango.pogo.pogoDsl.EventCriteria#getAbsChange <em>Abs Change</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Abs Change</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.EventCriteria#getAbsChange()
   * @see #getEventCriteria()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.esrf.tango.pogo.pogoDsl.EventCriteria#getPeriod <em>Period</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Period</em>'.
   * @see fr.esrf.tango.pogo.pogoDsl.EventCriteria#getPeriod()
   * @see #getEventCriteria()
   * @generated
   */
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute POGO_MULTI_CLASSES__COPYRIGHT = eINSTANCE.getPogoMultiClasses_Copyright();
    ...
    /**
     * The meta object literal for the '<em><b>Has Dynamic</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute ONE_CLASS_SIMPLE_DEF__HAS_DYNAMIC = eINSTANCE.getOneClassSimpleDef_HasDynamic();
     ...
     * @generated
     */
    EAttribute POGO_DEVICE_CLASS__POGO_REVISION = eINSTANCE.getPogoDeviceClass_PogoRevision();
    ...
    /**
     * The meta object literal for the '<em><b>Forwarded Attributes</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
     ...
     * @generated
     */
    EAttribute CLASS_DESCRIPTION__COPYRIGHT = eINSTANCE.getClassDescription_Copyright();
    ...
    /**
     * The meta object literal for the '<em><b>Event Criteria</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference ATTRIBUTE__EVENT_CRITERIA = eINSTANCE.getAttribute_EventCriteria();

    /**
     * The meta object literal for the '<em><b>Ev Archive Criteria</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    /**
     * The meta object literal for the '{@link fr.esrf.tango.pogo.pogoDsl.impl.ForwardedAttributeImpl <em>Forwarded Attribute</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.esrf.tango.pogo.pogoDsl.impl.ForwardedAttributeImpl
     * @see fr.esrf.tango.pogo.pogoDsl.impl.PogoDslPackageImpl#getForwardedAttribute()
     * @generated
     */
    EClass FORWARDED_ATTRIBUTE = eINSTANCE.getForwardedAttribute();
     ...
     * @generated
     */
    EAttribute FORWARDED_ATTRIBUTE__NAME = eINSTANCE.getForwardedAttribute_Name();
     ...
     * @generated
     */
    EAttribute FORWARDED_ATTRIBUTE__LABEL = eINSTANCE.getForwardedAttribute_Label();
     ...
     * @generated
     */
    EReference FORWARDED_ATTRIBUTE__STATUS = eINSTANCE.getForwardedAttribute_Status();
    ...
    /**
     * The meta object literal for the '{@link fr.esrf.tango.pogo.pogoDsl.impl.EventCriteriaImpl <em>Event Criteria</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.esrf.tango.pogo.pogoDsl.impl.EventCriteriaImpl
     * @see fr.esrf.tango.pogo.pogoDsl.impl.PogoDslPackageImpl#getEventCriteria()
     * @generated
     */
    EClass EVENT_CRITERIA = eINSTANCE.getEventCriteria();

    /**
     * The meta object literal for the '<em><b>Rel Change</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute EVENT_CRITERIA__REL_CHANGE = eINSTANCE.getEventCriteria_RelChange();

    /**
     * The meta object literal for the '<em><b>Abs Change</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute EVENT_CRITERIA__ABS_CHANGE = eINSTANCE.getEventCriteria_AbsChange();
     ...
     * @generated
     */
    EAttribute EVENT_CRITERIA__PERIOD = eINSTANCE.getEventCriteria_Period();
