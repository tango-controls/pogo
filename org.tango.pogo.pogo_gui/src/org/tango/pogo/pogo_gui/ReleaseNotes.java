...
public interface ReleaseNotes {
	String htmlString = 
		...
		"generated: 16-06-2020  08:49</center>\n" + 
		...
		"&nbsp; &nbsp; &nbsp; Last release compiled and executed with JAVA 8<br>" + 
		"&nbsp; &nbsp; &nbsp; Pull request #94 integration<br>" + 
		"<li><b>Pogo-9.6.28 - 06/02/2020:</b><br>" + 
		"&nbsp; &nbsp; &nbsp; Pull requests #87 and #91 integration<br>" + 
		...
		"&nbsp; &nbsp; &nbsp; Fix a problem when conning property Class/Device<br>" + 
		"&nbsp; &nbsp; &nbsp; Pull request #72 from SKA<br>" + 
		...
		"<li><b>Pogo-9.6.20 - 21/05/2019:</b><br>" + 
		"&nbsp; &nbsp; &nbsp; Improve additional files management in CMakelist.txt<br>" + 
		"<li><b>Pogo-9.6.19 - 10/05/2019:</b><br>" + 
		...
		"&nbsp; &nbsp; &nbsp; Fix a bug in dimX/dimY on java image attributes.<br>" + 
		"<li><b>Pogo-9.6.16 - 03/10/2018:</b><br>" + 
		"&nbsp; &nbsp; &nbsp; When generate html doc, if NO_PDF=true, does not generate (Soleil request)<br>" + 
		...
		"&nbsp; &nbsp; &nbsp; Fix bug in relative path for multiple classes.<br>" + 
		"&nbsp; &nbsp; &nbsp; It is now possible to load a server even a class has not be found.<br>" + 
