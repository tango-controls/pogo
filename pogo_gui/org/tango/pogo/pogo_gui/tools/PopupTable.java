...
public class PopupTable extends JDialog
{
	 ...
	 */
	//===============================================================
	public PopupTable(JDialog parent, String title, String[] col, Vector<Vector<String>> v)
	{
		super(parent, false);
		this.parent = parent;
	 ...
	 */
	//===============================================================
	public PopupTable(JFrame parent, String title, String[] col, Vector<Vector<String>> v)
	{
		super(parent, false);
		this.parent = parent;
		buildObject(title, col, v);
	...
	//===============================================================
	//===============================================================
	private void buildObject(String title, String[] col, Vector<Vector<String>> v)
	{
		col_names = col;
		initComponents();
		data = v;
