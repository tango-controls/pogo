			...
			nameMappings = new HashMap<AbstractElement, String>() {
				{
					...
					put(grammarAccess.getMiscellaneousAccess().getGroup(), "rule__Miscellaneous__Group__0");
					...
					put(grammarAccess.getPogoDeviceClassAccess().getStatesAssignment_17(), "rule__PogoDeviceClass__StatesAssignment_17");
					put(grammarAccess.getPogoDeviceClassAccess().getMiscellaneousAssignment_18(), "rule__PogoDeviceClass__MiscellaneousAssignment_18");
					...
					put(grammarAccess.getClassDescriptionAccess().getHasAbstractCommandAssignment_9(), "rule__ClassDescription__HasAbstractCommandAssignment_9");
					put(grammarAccess.getClassDescriptionAccess().getHasAbstractAttributeAssignment_10(), "rule__ClassDescription__HasAbstractAttributeAssignment_10");
					...
					put(grammarAccess.getClassIdentificationAccess().getClassFamilyAssignment_1(), "rule__ClassIdentification__ClassFamilyAssignment_1");
					put(grammarAccess.getClassIdentificationAccess().getSiteSpecificAssignment_2(), "rule__ClassIdentification__SiteSpecificAssignment_2");
					put(grammarAccess.getClassIdentificationAccess().getPlatformAssignment_3(), "rule__ClassIdentification__PlatformAssignment_3");
					put(grammarAccess.getClassIdentificationAccess().getBusAssignment_4(), "rule__ClassIdentification__BusAssignment_4");
					put(grammarAccess.getClassIdentificationAccess().getManufacturerAssignment_5(), "rule__ClassIdentification__ManufacturerAssignment_5");
					put(grammarAccess.getClassIdentificationAccess().getReferenceAssignment_6(), "rule__ClassIdentification__ReferenceAssignment_6");
					...
					put(grammarAccess.getPropertyAccess().getDescriptionAssignment_3(), "rule__Property__DescriptionAssignment_3");
					put(grammarAccess.getPropertyAccess().getDefaultPropValueAssignment_5(), "rule__Property__DefaultPropValueAssignment_5");
					...
					put(grammarAccess.getAttributeAccess().getMemorizedAssignment_8(), "rule__Attribute__MemorizedAssignment_8");
					put(grammarAccess.getAttributeAccess().getMemorizedAtInitAssignment_9(), "rule__Attribute__MemorizedAtInitAssignment_9");
					put(grammarAccess.getAttributeAccess().getChangeEventAssignment_10(), "rule__Attribute__ChangeEventAssignment_10");
					...
					put(grammarAccess.getAttributeAccess().getExcludedStatesAssignment_15(), "rule__Attribute__ExcludedStatesAssignment_15");
					...
					put(grammarAccess.getMiscellaneousAccess().getMakefileHomeAssignment_0(), "rule__Miscellaneous__MakefileHomeAssignment_0");
					put(grammarAccess.getMiscellaneousAccess().getInstallHomeAssignment_1(), "rule__Miscellaneous__InstallHomeAssignment_1");
				}
			};
		}
