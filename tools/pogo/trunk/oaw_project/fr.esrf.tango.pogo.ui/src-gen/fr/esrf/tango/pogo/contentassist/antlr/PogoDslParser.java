			...
			nameMappings = new HashMap<AbstractElement, String>() {
				{
					...
					put(grammarAccess.getAttributeAccess().getIsDynamicAssignment_15(), "rule__Attribute__IsDynamicAssignment_15");
					put(grammarAccess.getAttributeAccess().getReadExcludedStatesAssignment_17(), "rule__Attribute__ReadExcludedStatesAssignment_17");
					put(grammarAccess.getAttributeAccess().getWriteExcludedStatesAssignment_19(), "rule__Attribute__WriteExcludedStatesAssignment_19");
