 ...
 * generated
 */
public class PogoDslExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(PogoDslExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		fr.esrf.tango.pogo.internal.PogoDslActivator instance = fr.esrf.tango.pogo.internal.PogoDslActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = fr.esrf.tango.pogo.internal.PogoDslActivator.getInstance().getInjector("fr.esrf.tango.pogo.PogoDsl");
