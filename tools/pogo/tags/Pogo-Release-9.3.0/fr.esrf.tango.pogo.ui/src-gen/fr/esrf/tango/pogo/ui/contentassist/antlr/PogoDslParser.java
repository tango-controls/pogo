		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRW_PipeTypeAccess().getAlternatives(), "rule__RW_PipeType__Alternatives");
					...
					put(grammarAccess.getPipeAccess().getGroup(), "rule__Pipe__Group__0");
					...
					put(grammarAccess.getLongVectorTypeAccess().getGroup(), "rule__LongVectorType__Group__0");
					put(grammarAccess.getULongVectorTypeAccess().getGroup(), "rule__ULongVectorType__Group__0");
					...
					put(grammarAccess.getPogoMultiClassesAccess().getCopyrightAssignment_8(), "rule__PogoMultiClasses__CopyrightAssignment_8");
					put(grammarAccess.getPogoMultiClassesAccess().getClassesAssignment_10(), "rule__PogoMultiClasses__ClassesAssignment_10");
					put(grammarAccess.getPogoMultiClassesAccess().getFilestogenerateAssignment_11(), "rule__PogoMultiClasses__FilestogenerateAssignment_11");
					put(grammarAccess.getPogoMultiClassesAccess().getPreferencesAssignment_12(), "rule__PogoMultiClasses__PreferencesAssignment_12");
					...
					put(grammarAccess.getPogoDeviceClassAccess().getPipesAssignment_24(), "rule__PogoDeviceClass__PipesAssignment_24");
					put(grammarAccess.getPogoDeviceClassAccess().getStatesAssignment_26(), "rule__PogoDeviceClass__StatesAssignment_26");
					put(grammarAccess.getPogoDeviceClassAccess().getPreferencesAssignment_27(), "rule__PogoDeviceClass__PreferencesAssignment_27");
					put(grammarAccess.getPogoDeviceClassAccess().getAdditionalFilesAssignment_29(), "rule__PogoDeviceClass__AdditionalFilesAssignment_29");
					put(grammarAccess.getPogoDeviceClassAccess().getOverlodedPollPeriodObjectAssignment_31(), "rule__PogoDeviceClass__OverlodedPollPeriodObjectAssignment_31");
					...
					put(grammarAccess.getClassDescriptionAccess().getCopyrightAssignment_10(), "rule__ClassDescription__CopyrightAssignment_10");
					put(grammarAccess.getClassDescriptionAccess().getHasMandatoryPropertyAssignment_11(), "rule__ClassDescription__HasMandatoryPropertyAssignment_11");
					put(grammarAccess.getClassDescriptionAccess().getHasConcretePropertyAssignment_12(), "rule__ClassDescription__HasConcretePropertyAssignment_12");
					put(grammarAccess.getClassDescriptionAccess().getHasAbstractCommandAssignment_13(), "rule__ClassDescription__HasAbstractCommandAssignment_13");
					put(grammarAccess.getClassDescriptionAccess().getHasAbstractAttributeAssignment_14(), "rule__ClassDescription__HasAbstractAttributeAssignment_14");
					put(grammarAccess.getClassDescriptionAccess().getDescriptionHtmlExistsAssignment_15(), "rule__ClassDescription__DescriptionHtmlExistsAssignment_15");
					...
					put(grammarAccess.getPipeAccess().getNameAssignment_0(), "rule__Pipe__NameAssignment_0");
					put(grammarAccess.getPipeAccess().getDescriptionAssignment_1(), "rule__Pipe__DescriptionAssignment_1");
					put(grammarAccess.getPipeAccess().getLabelAssignment_2(), "rule__Pipe__LabelAssignment_2");
					put(grammarAccess.getPipeAccess().getRwTypeAssignment_3(), "rule__Pipe__RwTypeAssignment_3");
					put(grammarAccess.getPipeAccess().getDisplayLevelAssignment_4(), "rule__Pipe__DisplayLevelAssignment_4");
					put(grammarAccess.getPipeAccess().getReadExcludedStatesAssignment_6(), "rule__Pipe__ReadExcludedStatesAssignment_6");
					put(grammarAccess.getPipeAccess().getWriteExcludedStatesAssignment_8(), "rule__Pipe__WriteExcludedStatesAssignment_8");
				}
			};
		}
