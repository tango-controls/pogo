 ...
 * <ul>
 *   <li>{@link fr.esrf.tango.pogo.pogoDsl.PogoMultiClasses#getPogoRevision <em>Pogo Revision</em>}</li>
...
public interface PogoMultiClasses extends EObject
{
   ...
   * @see fr.esrf.tango.pogo.pogoDsl.PogoDslPackage#getPogoMultiClasses_PogoRevision()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.esrf.tango.pogo.pogoDsl.PogoMultiClasses#getPogoRevision <em>Pogo Revision</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
