...
public class PropertyDialog extends JDialog
{
	...
	public static String pogo2tangoType(PropType type)
	{
		...
		if (strPogoType.startsWith(header))
		{
			...
			{
				if (tangoType.indexOf("ShortVector")>=0)
					return propertyTypeNames[shortVector];
				if (tangoType.indexOf("IntVector")>=0)
					return propertyTypeNames[intVector];
				if (tangoType.indexOf("FloatVector")>=0)
					return propertyTypeNames[floatVector];
				if (tangoType.indexOf("DoubleVector")>=0)
					return propertyTypeNames[doubleVector];
				if (tangoType.indexOf("StringVector")>=0)
	...
	//===============================================================
	//===============================================================
    public static void popupSummary(JFrame parent, Vector<Property> vp, boolean is_dev)
    {
		Vector<Vector<String>>	summary = buildSummary(vp);
	...
	//===============================================================
	//===============================================================
	public static Vector<Vector<String>> buildSummary(Vector<Property> vp)
	{
