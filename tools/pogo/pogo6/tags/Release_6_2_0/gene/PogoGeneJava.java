...
//
// $Log$
// Revision 3.6  2007/08/07 13:06:00  pascal_verdier
// Generate Makefile and Windows Project management added.
//
// Revision 3.5  2006/06/26 09:22:47  pascal_verdier
...
//
// Revision 3.4  2005/11/24 08:29:49  pascal_verdier
...
//=======================================================================
	...
	{
		String template = pogo.templates_dir + "/java/" +
		...
		for (int i=0 ; i<pogo.commands.size() ; i++)
		{
			...
			{
				String	servercmd = pogo.projectFiles.getPath() + "/" + cmd.cmd_class + ".java";
				PogoString	pgs;
...
//=======================================================================
										...
										PogoException
	{
		...
		String	server      = pogo.projectFiles.getPath() + "/" + pogo.class_name + ".java";
		String	serverclass = pogo.projectFiles.getPath() + "/" + pogo.class_name + "Class.java";

		strTrace = "Java source code generation:\n\n";
		...
		//	Generate Makefile
		//------------------------------
		if (mustGenerate(makefile) || item==GENE_MAKEFILE)
		{
			generateMakefile(makefile);
			strTrace += makefile + "        Generated\n";
		}
