...
public class CppServer extends PogoGene implements PogoDefs, TangoConst
{
	...
	private boolean			is_superclass = false;
	//================================================================
	/**
	 *	Constructor
	 */
	...
	public CppServer(PogoClass pogo)
	{
		...
		is_superclass = pogo.is_superclass;
...
//=======================================================================
						...
						throws	PogoException
	{
		...
		if ((start=readcode.str.indexOf("public Tango::Device_2Impl"))<0 &&
			(start=readcode.str.indexOf("public Tango::Device_3Impl"))<0 )
	 ...
	 */
	//================================================================
	private String toSuperClassHeader(String str)
	{
										...
										PogoException
	{
		...
		if (pogo.is_superclass)
		{
			newcode = toSuperClassHeader(newcode);
		}
...
//=========================================================================
										...
										PogoException
	{
		...
		//--------------------------------------------------------
		int	namespace = readcode.indexOf("namespace " + pogo.class_name);
