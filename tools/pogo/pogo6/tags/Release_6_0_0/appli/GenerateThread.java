...
// $Version$
// $Log$
// Revision 3.7  2007/08/07 13:04:42  pascal_verdier
// Generate Makefile and Windows Project menu added.
//
// Revision 3.6  2006/11/02 11:39:45  pascal_verdier
   ...
   public void run()
	{
		try
		{
			...
			case GENE_WIN_PROJ:
                ...
                {
                    dialog.stop();
                    app_util.PopupError.show(parent, "No Makefile for python language.");
                }
                else
                if (pogo.language==javaLang)
                {
