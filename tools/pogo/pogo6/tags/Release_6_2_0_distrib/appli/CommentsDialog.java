...
//
// $Log$
// Revision 1.4  2006/11/02 11:39:44  pascal_verdier
// Python code generation added.
//
// Revision 1.3  2006/06/26 09:24:53  pascal_verdier
...
//
// Revision 1.2  2005/11/24 08:28:45  pascal_verdier
...
public class CommentsDialog extends JDialog
	implements TangoConst, PogoDefs, PogoAppliDefs
{
	/**
	 *	Events Table 
	 */
	...
	private Vector			tmp_state_vector = null;
 	...
 	private final static String[]	collec_names = {
						"Class  Properties",
						"Device Properties",
						"Commands" ,
						"Attributes",
	...
	private void displayDescriptions()
	{
		...
		case ATTRIBUTES:
			...
			for (int i=0 ; i<attr_vector.size() ; i++)
			{
				...
				{
					tmp[DESCRIPTION] = new String(attr.getDescription());
