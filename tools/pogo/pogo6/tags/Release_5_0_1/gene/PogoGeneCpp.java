...
//=======================================================================
/**
 *	Build a basic project file for VCC
 */
//=======================================================================
...
//=======================================================================
										...
										PogoException
	{
        ...
        if (!pogo.is_abstractclass)
        {
            if (!PogoUtil.osIsUnix())
            {
                 if (mustGenerate(WinDsp))
                 {
                     //  Try to ceate a basic Vcc project file
            ...
            else
            {
                if (mustGenerate(makefile))
                {
                    ...
                    strTrace += makefile + " for C++     Created\n";
                }
                else
                {
