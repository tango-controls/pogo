 ...
 */
private static String revNumber = "Release 5.0.0  -  Mon Dec 18 16:12:17 CET 2006";
/**
 ...
 */
 ...
 //===========================================================
	public PogoAppli()
	{
        ...
        inheritanceTree.setVisible(false);
...
//===========================================================
    ...
    private void initComponents() {
        ...
        pyBtn.setToolTipText("The device server will be generated in Java");
...
//===========================================================
	private void helpAP (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_helpAP
		...
		if (cmd.equals("TANGO Programmer's Guide"))
		{
			String	template;
	...
	private void customMenu()
	{
		...
		if ((template=System.getProperty("TEMPL_HOME"))!=null)
		{
			...
			if (f.exists())
			{
				...
				item.setText("TANGO Programmer's Guide");
