...
//=======================================================================
						...
						throws	IOException
	{
        ...
        {
            int pos = pgs.indexOf(server.author);
			if (pos>0)
			{
			 	pos += server.author.length();
...
//=======================================================================
            ...
            throws	IOException, PogoException
    {
        ...
        return takeOffHeaderAndFooter(code, true) + "\n</center>\n";
    }
//=======================================================================
//=======================================================================
...
//=======================================================================
	...
	private String buildTitle(String code)
	{
		...
		pos2 = title.indexOf("\n", pos);
		new_title += "<b>" + title.substring(pos, pos2+1);
		new_title += "</b>\n</Td></Tr>\n</center>\n</Table>\n";
...
//=======================================================================
    protected void generateFull()
			throws	IOException, PogoException
    {
		//	Do it only during automatic doc generation
		//if (System.getProperty("TABLE_TITLES")==null)
		//	return;
           ...
           ! server.inheritedClassName().equals(tangoDeviceImpl))
        {
            ...
            pos = code.indexOf(intro);
            code = code.substring(0, pos) + inheritance_message +
                    code.substring(pos);
        }
