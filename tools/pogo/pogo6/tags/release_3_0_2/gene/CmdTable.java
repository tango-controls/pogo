 ...
 */
//-======================================================================
public class CmdTable implements PogoDefs
{
/**
...
//============================================================================
	public CmdTable(Vector v_in)
	{
		...
		for (int i=vect.size() ; i<v_in.size() ; i++)
 ...
 */
//============================================================================
	public CmdTable(String filename) throws	FileNotFoundException,
										SecurityException,
										IOException,
										PogoException
	{
		...
		for (int i=0 ; (i=cmd_factory.indexOf(add_list_str, i))>0 ; i++)
		{
			...
			cmd.setPolledPerriod(cmd_factory);
			...
			case javaLang:
				...
				fid = new FileInputStream(new String(path + "/" + 
...
//============================================================================
	public void getDescriptions(String descFile, String serverClass, int lang)
								throws	FileNotFoundException,
										...
										PogoException
	{
		//	Modify filename. Dependinds on language
		//------------------------------------------
		...
		for (int i=0 ; i<vect.size(); i++)
		{
			...
			if (cmd.virtual_method==false)
			{
				...
				case cppLang:
					...
					break;
				case javaLang:
					String	cmdFile = new String(path +
								"/" + cmd.cmd_class + javaExtention);
		...
		for (int i=0 ; i<vect.size(); i++)
		{
			if (cmdIdx(i).virtual_method==false)
				cmdIdx(i).getExecMethodDescription(str, lang);
		}
	}
//============================================================================
/**
...
//============================================================================
	public String toString(int idx) throws PogoException
	{
		...
		else
		{
			...
			str = new String(cmd.command+", "   + cmd.cmd_class+", " +
...
//============================================================================
	public String toString()
	{
		...
		for (int i=0 ; i< vect.size(); i++)
		{
			...
			buff.append(cmd.command+", "   + cmd.cmd_class+", " +
						cmd.argin.cpp_code_str+", " + cmd.argout.cpp_code_str);
