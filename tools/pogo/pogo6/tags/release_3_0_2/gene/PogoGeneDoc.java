...
//=======================================================================
	public PogoGeneDoc(PogoClass pogo)
	{
		super(pogo);
		this.pogo = pogo;
		outDoc = new String(pogo.output_files + "/doc_html");
...
//=======================================================================
	private String generateProgrammersGuide() throws
										...
										PogoException
	{
		//	First time generate programmer's guide
		//----------------------------------------------
		String[]	cmd;
...
//	The following part has been commented for problems under Windows !!!
//=======================================================================
/*
...
//=======================================================================
	private String[] buildCmdDocFromCpp() throws 
										...
										PogoException
	{
		//	Fisrt time buid Doxyfile from template
		String	template  = new String(pogo.templates_dir + "/html/Doxyfile");
		String	doxyfile  = new String(pogo.output_files + "/Doxyfile");
		...
		code.replace("POGO_SRC_FILES", pogo.output_files);
		...
		//	Then build command
 		String[]	cmd = new String[2];
   		...
   		String	docPath;
		int	n = 0 ;
		if ((docPath=System.getProperty("CPP_DOC_PATH"))!=null)
...
//=======================================================================
						...
						throws	IOException, PogoException
	{
		...
		//----------------------------------------------
		writeDocFile("index.html", pgs.str, true);
	}
//=======================================================================
/**
...
//=======================================================================
						...
						throws	IOException, PogoException
	{
		...
		pgs.append("<Center>\n");
		pgs.append("<Br>\n<Br>\n<Br>\n<Br>\n<Br>\n<Br>\n");
		pgs.append("This Page Must Be Filled by <Br>\n");
		pgs.append("The Programmer\n");
		pgs.append("</Center>\n");

		//	Open Output file and search place to write
		//----------------------------------------------
		writeDocFile("Description", pgs.str, true);
	}
//=======================================================================
/**
...
//=======================================================================
						...
						throws	IOException, PogoException
	{
		...
		writeDocFile("TangoDevStates.html", pgs.str, true);
	}
//=======================================================================
/**
...
//=======================================================================
						...
						throws	IOException, PogoException
	{
		...
		if (pogo.class_properties.size() > 0)
		{
			...
			{
				Property	property = pogo.class_properties.elementAt(i);
		...
		if (pogo.dev_properties.size() > 0)
		{
			...
			{
				Property	property = pogo.dev_properties.elementAt(i);
		...
		//----------------------------------------------
		writeDocFile("Properties.html", pgs.str, true);
	}
//=======================================================================
/**
...
//=======================================================================
						...
						throws	IOException, PogoException
	{
		...
		//	Open Output file and search place to write
		//----------------------------------------------
		writeDocFile("Attributes.html", pgs.str, true);
	}
//=======================================================================
/**
 *	Create the DevCommands.html file from template file and PogoClass Object.
...
//=======================================================================
						...
						throws	IOException, PogoException
	{
		...
		for (int i=0 ; i<pogo.commands.size() ; i++)
		{
			...
			str += "<A Href=\"DevCommands.html#" + cmd.command;
			str += "\" TARGET=\"DevCommands\"> ";
			str += 	cmd.command + "</a><Br>\n";
		}
		...
		*/
		...
		//	Open Output file and  write
		//----------------------------------------------
		writeDocFile("DevCommandsList.html", str, false);
...
//=======================================================================
	...
	{
		PogoString	pgs =
			new PogoString("<A NAME=\"" + cmd.command  + "\"><!-- --></A>\n");

			//	Label for Href html command
			pgs.append("<A NAME=\"" + cmd.command  + "\"><!-- --></A>\n");
			//	Cmd name
			pgs.append("<h2>" + cmd_idx + " - " + cmd.command);
			...
			if (cmd.argin.description!=null)
				pgs.append(" : " + cmd.argin.description);
			...
			if (cmd.argout.description!=null)
				pgs.append(" : " + cmd.argout.description);
			...
			if (cmd.notAllowedFor!=null)
			{
				...
				{
					DevState	st = pogo.states.elementAt(idx);
					boolean 	found=false;
...
//=======================================================================
						...
						throws	IOException, PogoException
	{
		...
		//	Open Output file and search place to write
		//----------------------------------------------
		writeDocFile("DevCommands.html", pgs.str, true);
	}
//=======================================================================
/**
 *	Create the DevCommands.html file from template file and PogoClass Object.
...
//=======================================================================
						...
						throws	IOException, PogoException
	{
		...
		//	Add the non overwritable command init
		pgs.append(new String("<Tr><Td>"+ init_cmd.command +"</Td>\n"));
		...
		if (nb_expert>0)
		{
			...
			for (int i=0 ; i<pogo.commands.size() ; i++)
			{
				...
				{
					pgs.append("<Tr><Td>"+ cmd.command +"</Td>\n");
		...
		//	Open Output file and write
		//----------------------------------------------
		writeDocFile("DevCommandsTable.html", pgs.str, true);
	}
//=======================================================================
/**
...
//=======================================================================
						...
						throws	IOException, PogoException
	{
		...
		FileOutputStream	fidout = new FileOutputStream(outDoc + "/" + filename);
 ...
 *	@param	pagetitle	text to be used as title.
 */
//=======================================================================
