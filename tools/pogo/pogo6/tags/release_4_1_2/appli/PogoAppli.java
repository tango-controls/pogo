 ...
 *
 *  @see <a href=http://www/tango/tango.html target="new"> Tango Pages</a>
 */
//===========================================================
 ...
 */
private static String revNumber = "Revision 4.1.2  -  Tue Feb 15 11:46:01 CET 2005";
/**
...
//======================================================
  ...
  private void generateSource(int item, int exiting)
  {
	...
	if (item==GENE_SRC)
	{
		...
		if (dialog.showDialog(homeDir, server.is_superclass) != PogoAppliDefs.RET_OK)
			return;
		homeDir = dialog.getOutputPath();
		server.is_superclass = dialog.getOutputModel();
		tree.setHomeDir(homeDir);
		tree.setOutputModel(server.is_superclass);
	}
	if (lang==javaLang)
	{
	...
	//	if not test --> do not manage SuperClass
	String	test = System.getProperty("POGO_MODE");
	if (lang==javaLang || test==null)
		server.is_superclass = false;
...
//======================================================
	private void customMenu()
	{
		...
		jLabel1.setIcon (new ImageIcon(getClass().getResource("/pogo/img/pogo.jpg")));
   ...
   //======================================================
	...
	public static void main(java.lang.String[] args) {
		...
		try
		{
			...
			// if not empty (or if dbg property set), open file selection boxe
