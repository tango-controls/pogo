...
//=======================================================================
									...
									PogoException
	{
		...
		class_properties.readDefaultValues(projectFiles.getServerClass(), classProperty, language);
		dev_properties   = new PropertyTable(serverDescriptionFile, devProperty, language);
		dev_properties.readDefaultValues(projectFiles.getServerClass(), devProperty, language);
...
//=======================================================================
									...
									IOException
	{
		...
		if (language==cppLang)
		{
			String	classfile = projectFiles.getPath()+"/"+class_name+"Class.cpp";
			String	tmp = PogoUtil.getTagRevision(classfile, class_name);
			if (tmp!=null)
				revision = tmp;
