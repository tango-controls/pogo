...
public class PogoDslGrammarAccess implements IGrammarAccess {
	...
	public class ClassIdentificationElements implements IParserRuleAccess {
		...
		private final Assignment cClassFamilyAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cClassFamilySTRINGTerminalRuleCall_1_0 = (RuleCall)cClassFamilyAssignment_1.eContents().get(0);
		private final Assignment cSiteSpecificAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cSiteSpecificSTRINGTerminalRuleCall_2_0 = (RuleCall)cSiteSpecificAssignment_2.eContents().get(0);
		private final Assignment cPlatformAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cPlatformSTRINGTerminalRuleCall_3_0 = (RuleCall)cPlatformAssignment_3.eContents().get(0);
		private final Assignment cBusAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cBusSTRINGTerminalRuleCall_4_0 = (RuleCall)cBusAssignment_4.eContents().get(0);
		private final Assignment cManufacturerAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cManufacturerSTRINGTerminalRuleCall_5_0 = (RuleCall)cManufacturerAssignment_5.eContents().get(0);
		private final Assignment cReferenceAssignment_6 = (Assignment)cGroup.eContents().get(6);
		private final RuleCall cReferenceSTRINGTerminalRuleCall_6_0 = (RuleCall)cReferenceAssignment_6.eContents().get(0);
		...
		//	      	 //	class family to be sorted in html doc
		public Assignment getClassFamilyAssignment_1() { return cClassFamilyAssignment_1; }

		//STRING   	 //	class family to be sorted in html doc
		public RuleCall getClassFamilySTRINGTerminalRuleCall_1_0() { return cClassFamilySTRINGTerminalRuleCall_1_0; }

		//siteSpecific=STRING 	 //	class family to be sorted in html doc
		//	     	 //	If specific for an institute, name of this institute
		public Assignment getSiteSpecificAssignment_2() { return cSiteSpecificAssignment_2; }

		//STRING   	 //	If specific for an institute, name of this institute
		public RuleCall getSiteSpecificSTRINGTerminalRuleCall_2_0() { return cSiteSpecificSTRINGTerminalRuleCall_2_0; }
		...
		public RuleCall getPlatformSTRINGTerminalRuleCall_3_0() { return cPlatformSTRINGTerminalRuleCall_3_0; }
		...
		public RuleCall getBusSTRINGTerminalRuleCall_4_0() { return cBusSTRINGTerminalRuleCall_4_0; }

		//manufacturer=STRING 	 //	Hardware bus to control.
		//	     	 //	mannufacturer if any
		public Assignment getManufacturerAssignment_5() { return cManufacturerAssignment_5; }

		//STRING   	 //	mannufacturer if any
		public RuleCall getManufacturerSTRINGTerminalRuleCall_5_0() { return cManufacturerSTRINGTerminalRuleCall_5_0; }

		//reference=STRING 	 //	mannufacturer if any
		public Assignment getReferenceAssignment_6() { return cReferenceAssignment_6; }

		//STRING
		public RuleCall getReferenceSTRINGTerminalRuleCall_6_0() { return cReferenceSTRINGTerminalRuleCall_6_0; }
	}
	...
	public class PropertyElements implements IParserRuleAccess {
		...
		private final Keyword cDefaultPropValueKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cDefaultPropValueAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cDefaultPropValueSTRINGTerminalRuleCall_4_0 = (RuleCall)cDefaultPropValueAssignment_4.eContents().get(0);
		...
		//"defaultPropValue:"
		public Keyword getDefaultPropValueKeyword_3() { return cDefaultPropValueKeyword_3; }

		//DefaultPropValue+=STRING*
		public Assignment getDefaultPropValueAssignment_4() { return cDefaultPropValueAssignment_4; }

		//STRING
		public RuleCall getDefaultPropValueSTRINGTerminalRuleCall_4_0() { return cDefaultPropValueSTRINGTerminalRuleCall_4_0; }
	}
	...
	public class CommandElements implements IParserRuleAccess {
		...
		private final RuleCall cAbstractBooleanParserRuleCall_4_0 = (RuleCall)cAbstractAssignment_4.eContents().get(0);
		...
		//Boolean
		public RuleCall getAbstractBooleanParserRuleCall_4_0() { return cAbstractBooleanParserRuleCall_4_0; }
	...
	public class AttributeElements implements IParserRuleAccess {
		...
		private final Assignment cRwTtypeAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cRwTtypeRW_TypeParserRuleCall_3_0 = (RuleCall)cRwTtypeAssignment_3.eContents().get(0);
		...
		private final Assignment cPropertiesAssignment_12 = (Assignment)cGroup.eContents().get(12);
		private final RuleCall cPropertiesAttrPropertiesParserRuleCall_12_0 = (RuleCall)cPropertiesAssignment_12.eContents().get(0);
		private final Keyword cExcludedStatesKeyword_13 = (Keyword)cGroup.eContents().get(13);
		private final Assignment cExcludedStatesAssignment_14 = (Assignment)cGroup.eContents().get(14);
		private final RuleCall cExcludedStatesSTRINGTerminalRuleCall_14_0 = (RuleCall)cExcludedStatesAssignment_14.eContents().get(0);
		...
		//rwTtype=RW_Type
		public Assignment getRwTtypeAssignment_3() { return cRwTtypeAssignment_3; }

		//RW_Type
		public RuleCall getRwTtypeRW_TypeParserRuleCall_3_0() { return cRwTtypeRW_TypeParserRuleCall_3_0; }
		...
		public Assignment getPropertiesAssignment_12() { return cPropertiesAssignment_12; }

		//AttrProperties
		public RuleCall getPropertiesAttrPropertiesParserRuleCall_12_0() { return cPropertiesAttrPropertiesParserRuleCall_12_0; }

		//"excludedStates:"
		public Keyword getExcludedStatesKeyword_13() { return cExcludedStatesKeyword_13; }

		//excludedStates+=STRING*
		public Assignment getExcludedStatesAssignment_14() { return cExcludedStatesAssignment_14; }

		//STRING
		public RuleCall getExcludedStatesSTRINGTerminalRuleCall_14_0() { return cExcludedStatesSTRINGTerminalRuleCall_14_0; }
	}
