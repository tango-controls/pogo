		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOneClassSimpleDefAccess().getPogoRevisionAssignment_0(), "rule__OneClassSimpleDef__PogoRevisionAssignment_0");
					put(grammarAccess.getOneClassSimpleDefAccess().getClassnameAssignment_1(), "rule__OneClassSimpleDef__ClassnameAssignment_1");
					put(grammarAccess.getOneClassSimpleDefAccess().getSourcePathAssignment_2(), "rule__OneClassSimpleDef__SourcePathAssignment_2");
					put(grammarAccess.getOneClassSimpleDefAccess().getHasDynamicAssignment_3(), "rule__OneClassSimpleDef__HasDynamicAssignment_3");
					put(grammarAccess.getOneClassSimpleDefAccess().getPogo6Assignment_4(), "rule__OneClassSimpleDef__Pogo6Assignment_4");
					put(grammarAccess.getOneClassSimpleDefAccess().getInheritancesAssignment_6(), "rule__OneClassSimpleDef__InheritancesAssignment_6");
					put(grammarAccess.getOneClassSimpleDefAccess().getParentClassesAssignment_8(), "rule__OneClassSimpleDef__ParentClassesAssignment_8");
					put(grammarAccess.getOneClassSimpleDefAccess().getAdditionalFilesAssignment_10(), "rule__OneClassSimpleDef__AdditionalFilesAssignment_10");
