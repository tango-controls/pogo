...
//
// $Log$
// Revision 3.3  2006/06/26 09:22:47  pascal_verdier
...
//
// Revision 3.2  2005/11/24 08:29:16  pascal_verdier
...
//======================================================================
	public DevState(String sName, String desc)
	{
		...
		if ((start=sName.indexOf(java_begin))>=0)
		{
			...
			sName = "Tango::" + sName.substring(start);
		}
...
//======================================================================
	public String javaName()
	{
		...
		if (start<0)
			...
			start = "Tango::".length();
		return "DevState." + name.substring(start);
	}
//======================================================================
/**
 * build python state name.
 *
 * @return A <i>java.lang.String</i> containing state's python name.
 */
//======================================================================
	public String getPyName()
	{
        String  real_name = name.substring(name.indexOf("::")+2);
        return "PyTango.DevState." + real_name;
	}
//======================================================================
/**
...
//======================================================================
/**
 * Make state as a String with its description.
 *
