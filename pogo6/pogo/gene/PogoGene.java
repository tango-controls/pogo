...
//
// $Log$
// Revision 3.13  2007/09/14 14:33:19  pascal_verdier
...
//=======================================================================
//=======================================================================
	protected boolean writeDeviceIdFile() throws	PogoException,
												IOException,
												FileNotFoundException
	{
		String	filename = DeviceID.getFilename(pogo.projectFiles.getPath() + "/");
		boolean	writeIt = false;
		
		//	If file already exists, check if data have been modified
		if (new File(filename).exists())
		{
			DeviceID	device_id = new DeviceID(PogoUtil.readFile(filename));
			writeIt = (device_id.toString().equals(pogo.device_id.toString())==false);
		}
		else
			writeIt = true;
		if (writeIt)
			PogoUtil.writeFile(filename, pogo.device_id.toString());
		return writeIt;
	}
}
//-----------------------------------------------------------------------------
