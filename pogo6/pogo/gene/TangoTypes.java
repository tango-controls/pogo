...
//
// $Log$
// Revision 3.10  2007/06/13 08:10:41  pascal_verdier
// Taco device is now created on TCP mode.
//
...
//==============================================
	public TangoTypes(String type)
	{
		...
		//---------------------------------------------
            ...
            if (type.equals("Tango::DevEncoded"))
...
//==============================================	
	private void createType(String type)
	{
		...
		if (type.equals("Tango::DEV_ENCODED"))
		{
			code = Tango_DEV_ENCODED;
			cpp  = "Tango::DevEncoded";
			java = "DevEncoded";
			is_array = false;
			need_constr = true;
			need_2constr= false;
