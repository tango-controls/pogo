...
//
// $Log$
// Revision 3.10  2006/11/02 11:39:45  pascal_verdier
// Python code generation added.
//
// Revision 3.9  2006/06/26 09:24:53  pascal_verdier
...
//===============================================================
	...
	private String verifyDefaultValue()
	{
		...
		String[]	def_val  = 
			new PogoString(valTxt.getText().trim()).stringLines2array();
		...
		for (int i=0 ; i<def_val.length ; i++)
		{
			try
			{
				...
				if (type.indexOf("boolean")>=0)
					if (!def_val[i].toLowerCase().equals("true") &&
						!def_val[i].toLowerCase().equals("false") )
							err_mess = "Property's default value " + 
								"is not coherent with selected type !\n" +
	...
	private void initializeWindow(Property property)
	{
		if (property!=null)
		{
			...
			if (property.type.code == Tango_CONST_DEV_STRING	||
				...
				property.type.cpp_code_str = "string";
