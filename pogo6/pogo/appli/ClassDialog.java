...
//
// Revision 3.7  2005/06/14 08:48:39  pascal_verdier
// SuperClass is replaced by AbstractClass.
//
// Revision 3.6  2005/03/29 15:01:30  pascal_verdier
...
//===================================================================
	...
	public ClassDialog(JFrame parent, ServerDefinitions defs)
	{
		...
		//	Add abstractclass list in combo box if any
		{
			String[]	tmp;
			...
			{
				tmp =  PogoUtil.getInstance().abstractClassList();

				//	Store full path and name
				class_list = new String[tmp.length+1];
				class_list[0] = impl_txt;
                System.arraycopy(tmp, 0, class_list, 1, tmp.length);
			}
			else
			{
			...
			for (int i=0 ; i<class_list.length ; i++)
			{
				...
				abstractClassComboBox.addItem(classname);
...
//===================================================================
        private void initComponents() {//GEN-BEGIN:initComponents
              ...
              abstractClassComboBox = new javax.swing.JComboBox();
              ...
              gridBagConstraints1.gridx = 1;
              gridBagConstraints1.gridy = 2;
              jPanel2.add(abstractClassComboBox, gridBagConstraints1);
...
//===========================================================
	ServerDefinitions getInput()
	{
		...
		if (class_list!=null)
		{
			String	str = class_list[abstractClassComboBox.getSelectedIndex()];
			...
			/*
			if (abstractClassComboBox.getSelectedIndex()==0)
				inherited_from = PogoDefs.tangoDeviceImpl;
			else
				inherited_from =
					class_list[abstractClassComboBox.getSelectedIndex()];
			*/
		}
...
//===================================================================
  ...
  private javax.swing.JComboBox abstractClassComboBox;
