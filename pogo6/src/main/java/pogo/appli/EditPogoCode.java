...
//
// $Log$
// Revision 3.4  2006/06/26 09:24:53  pascal_verdier
...
//=======================================================================
									...
									PogoException
	{
		...
		if (pogo.language == pyLang)
			target = cmd.buildPyExecCmdMethodSignature();
		else
			return;
...
//=======================================================================
											...
											PogoException
	{
		...
		if (pogo.language == pyLang)
			target = "def read_" + attname + "(self, attr):";
		else
			return;
