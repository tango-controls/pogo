...
//
// $Log$
// Revision 3.12  2009/02/18 15:03:49  pascal_verdier
...
public class TreePopupMenu extends JPopupMenu  implements PogoDefs, PogoAppliDefs
{
	...
	static private final int	DEV_CLASS_ID  = 13;
	...
	public void showMenu(MouseEvent evt)
	{
        ...
        getComponent(OFFSET+DEV_CLASS_ID).setVisible(false);
		...
		case CLASS_ROOT:
            ...
            getComponent(OFFSET+DEV_CLASS_ID).setVisible(true);
