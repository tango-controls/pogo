...
//
// $Log$
// Revision 3.18  2009/02/18 15:02:15  pascal_verdier
// Tango 7 (IDL 4) compatibility implementation.
//
// Revision 3.17  2007/06/13 07:52:58  pascal_verdier
// 64 bits data types added for java servers.
//
// Revision 3.16  2006/12/05 09:33:50  pascal_verdier
...
//-======================================================================
	public String[] isJavaCompatible()
	{
		String[]	AttrDataArray = {
							...
							"Tango::DEV_STRING",
							"Tango::DEV_STATE",
							//"Tango::DEV_ENCODED", //  Impossible (Not inside an any)
						};
		Vector	v = new Vector();
		for (int i=0 ; i<size() ; i++)
		{
