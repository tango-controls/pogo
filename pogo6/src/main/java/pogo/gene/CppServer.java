...
//
// $Log$
// Revision 3.22  2008/03/13 08:46:08  pascal_verdier
// Pb in properties order fixed.
//
// Revision 3.21  2008/02/22 10:10:50  pascal_verdier
...
//=======================================================================
										...
										PogoException
	{
        ...
        //  Check if last IDL version
        newcode = setLastIdlVersion(newcode);
       //	Open and write file
		//----------------------------------------
...
//=========================================================================
//=========================================================================
    private String setLastIdlVersion(String code)
    {
        String  last_idl = "Device_" + (cppDeviceImpl-1) + "Impl";
        String  new_idl  = "Device_" +  cppDeviceImpl    + "Impl";
        int pos;
        while ((pos=code.indexOf(last_idl))>0)
            code = code.substring(0, pos) + new_idl +
                    code.substring(pos+last_idl.length());
        return code;
    }
...
//=========================================================================
										...
										PogoException
	{
		...
		if (src_exist)
		{
			...
			int start = readcode.str.indexOf(target);
			if (start<0)
			{
				String	target2 = "\"" + pogo.class_name + "Class.h\"";
				start = readcode.str.indexOf(target2);
				if (start<0)
				{
					target2 = pogo.class_name + ".h";
        ...
        finalcode = setLastIdlVersion(finalcode);
