...
//
// $Log$
// Revision 3.17  2007/05/09 06:43:48  pascal_verdier
// Attribute name added in exception description.
//
// Revision 3.16  2007/03/09 12:03:01  pascal_verdier
...
//======================================================================
				...
				throws	PogoException
	{
		...
		if (start<0)
		{
			...
			if (start<0)
				throw new PogoException("Attribute ("+name+
							") class not defined in header file !");
		}
...
//======================================================================
	public void getDefaultProperties(PogoString pgs, int lang)
	{
		...
		if ((start=pgs.str.indexOf(pattern + name+"\n"))<0)
			return;
